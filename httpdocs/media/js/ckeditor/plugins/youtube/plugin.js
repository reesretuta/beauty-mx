								...
								[{
									...
									validate : function ()
									{
										if ( this.isEnabled() )
										{
											if ( !this.getValue() )
											{
												alert( 'You must input an embed code or URL' );
												return false;
											}
											else
											if ( this.getValue().length === 0 || this.getValue().indexOf( '//' ) === -1 )
											{
												alert( 'The embed code you\'ve entered doesn\'t appear to be valid' );
												return false;
											}
										}
									}
											...
											validate : function ()
											{
												if ( this.isEnabled() )
												{
													if ( !this.getValue() )
													{
														...
														{
															alert( 'The URL you\'ve entered doesn\'t appear to be valid' );
															return false;
														}
													}
												}
										...
										},
										{
											...
											validate : function ()
											{
												if ( this.getValue() )
												{
													...
													alert( 'You must enter the width' );
													return false;
												}
											}
										},
										{
											...
											validate : function ()
											{
												if ( this.getValue() )
												{
													...
													alert( 'You must enter the height' );
													return false;
												}
											}
										}
									...
									[
										{
											...
											label : 'Show suggested videos at the video\'s end'
										},
										{
											id : 'chkOlderCode',
											type : 'checkbox',
											'default' : editor.config.youtube_older != null ? editor.config.youtube_older : false,
											label : 'Use old embed code'
										}
									]
								},
								{
									...
									[
										...
										},
										{
											id : 'txtStartAt',
											type : 'text',
											label : 'Start at (ss or mm:ss or hh:mm:ss)',
											validate : function ()
											{
												if ( this.getValue() )
												{
